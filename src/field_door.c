...
static const u8 sDoorAnimTiles_SayoriRoom[] = INCBIN_U8("graphics/door_anims/sayori_room.4bpp");
...
static const u8 sDoorAnimPalettes_SayoriRoom[] = {7, 7, 7, 7, 7, 7, 7, 7};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_SayoriRoom_Door,                              DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_SayoriRoom, sDoorAnimPalettes_SayoriRoom},
    {},
};
